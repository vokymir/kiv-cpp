...
class IDrawing {
public:
  enum class Color { Black, Blue, Green, Yellow, Red };
  ...
  // ulozi vystup do souboru, fileBaseName je nazev souboru bez pripony; priponu
  // pridava az implementace
...
private:
  //
  std::ostringstream mPrototype;

public:
  virtual void Init(int width, int height) override;
  virtual void Draw_Line(int fromX, int fromY, int toX, int toY,
                         Color clr) override;
