...
int main(int argc, char **argv) {
  ...
  std::for_each(ldr.begin(), ldr.end(),
                [&minmax](const Data_Loader::Line &line) {
  ...
  // std::println(std::cout, "{},{},{},{}", minmax.x1, minmax.y1, minmax.x2,
  //              minmax.y2);

  // std::for_each(ldr.begin(), ldr.end(), [](const Data_Loader::Line &line) {
  //   std::println(std::cout, "{},{},{},{},{}", line.x1, line.y1, line.x2,
  //                line.y2, line.color);
  // });
  // return 0;
